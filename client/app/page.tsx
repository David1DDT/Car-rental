          ...
          >
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-[1.2fr_1fr_1fr_auto]">
              <div>
                ...
                <select className="select select-bordered h-11 w-full rounded-md border-black/20 bg-white text-sm">
              ...
              <div>
                ...
                <div className="grid grid-cols-[1fr_108px] gap-2">
                  ...
                  />
                  <TimePickerInput className="input input-bordered h-11 w-full rounded-md border-black/20 bg-white text-sm" />
                </div>
              </div>
